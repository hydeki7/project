...
<html>
  ...
  <body class="hold-transition login-page" style="background-image:url('assets/img/bss.png'); background-repeat:no-repeat; background-size:contain; background-position:center;">
